/* Generated by Cython 0.15.1 on Mon Oct 21 12:14:35 2013 */
...
/* "playground/native_code/_lbfgs.pyx":37
 *     cdef _pele.Potential pot
 * 
...
static int __pyx_pf_10playground_11native_code_6_lbfgs_9LBFGS_CPP___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__cinit__");
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        ...
        if (likely(values[1])) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("__cinit__", 0, 2, 10, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (kw_args > 0) {
    ...
    if (values[4]) {
      __pyx_v_maxstep = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_maxstep == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 38; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {

      /* "playground/native_code/_lbfgs.pyx":38
 * 
 *     def __cinit__(self, _pele.Potential pot, np.ndarray[double, ndim=1,
 *                   mode="c"] x0, tol=1e-4, int M=4, double maxstep=0.1,             # <<<<<<<<<<<<<<
 *                   double maxErise=1e-4, double H0=0.1, int iprint=-1,
 ...
 */
    ...
    if (values[5]) {
      __pyx_v_maxErise = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_maxErise == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
 ...
 */
    ...
    if (values[6]) {
      __pyx_v_H0 = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_H0 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_H0 = ((double)0.1);
    }
    if (values[7]) {
      __pyx_v_iprint = __Pyx_PyInt_AsInt(values[7]); if (unlikely((__pyx_v_iprint == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_iprint = ((int)-1);
    }
    if (values[8]) {
      __pyx_v_nsteps = __Pyx_PyInt_AsInt(values[8]); if (unlikely((__pyx_v_nsteps == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_nsteps = ((int)10000);
    }
    if (values[9]) {
      __pyx_v_verbosity = __Pyx_PyInt_AsInt(values[9]); if (unlikely((__pyx_v_verbosity == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("__cinit__", 0, 2, 10, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_pot), __pyx_ptype_10playground_11native_code_5_pele_Potential, 1, "pot", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_x0), __pyx_ptype_5numpy_ndarray, 1, "x0", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_x0, (PyObject*)__pyx_v_x0, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_x0 = __pyx_bstruct_x0.strides[0];
  __pyx_bshape_0_x0 = __pyx_bstruct_x0.shape[0];

  /* "playground/native_code/_lbfgs.pyx":42
 *                   int nsteps=10000, int verbosity=0):
 *         self.thisptr = <cppLBFGS*>new cppLBFGS(pot.thisptr,
 ...
 *         opt = self.thisptr
 */
  __pyx_t_1 = PyObject_GetAttr(((PyObject *)__pyx_v_x0), __pyx_n_s__size); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  try {__pyx_t_3 = pele::Array(((double *)__pyx_v_x0->data), __pyx_t_2);} catch(...) {__Pyx_CppExn2PyErr(); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
 ...
 *         opt.set_H0(H0)
 */
  __pyx_t_4 = __pyx_PyFloat_AsDouble(__pyx_v_tol); if (unlikely((__pyx_t_4 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  try {__pyx_t_5 = new LBFGS_ns::LBFGS(__pyx_v_pot->thisptr, __pyx_t_3, __pyx_t_4, __pyx_v_M);} catch(...) {__Pyx_CppExn2PyErr(); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
 ...
 *                                                tol, M)
 */
  ((struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *)__pyx_v_self)->thisptr = ((LBFGS_ns::LBFGS *)__pyx_t_5);
 ...
 */
  try {((struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *)__pyx_v_self)->thisptr->run();} catch(...) {__Pyx_CppExn2PyErr(); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
 ...
 */
  ...
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s__get_result); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
...
/* "playground/native_code/_lbfgs.pyx":65
 * 
 *     @cython.boundscheck(False)
 *     def get_result(self):             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = __Pyx_GetName(__pyx_m, __pyx_n_s__Result); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__zeros); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_FromSize_t(__pyx_v_xi.size()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__zeros); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_FromSize_t(__pyx_v_xi.size()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    ...
    /* "playground/native_code/_lbfgs.pyx":77
 *         cdef size_t i
 *         for i in xrange(xi.size()):
 *             x[i] = xdata[i]             # <<<<<<<<<<<<<<
 *             g[i] = gdata[i]
 ...
 *         res.grad = g
 */
  __pyx_t_2 = PyFloat_FromDouble(((struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *)__pyx_v_self)->thisptr->get_f()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyObject_SetAttr(__pyx_v_res, __pyx_n_s__energy, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "playground/native_code/_lbfgs.pyx":88
 * 
 *         res.energy = self.thisptr.get_f()
 *         res.coords = x             # <<<<<<<<<<<<<<
 *         res.grad = g
 * 
 */
  if (PyObject_SetAttr(__pyx_v_res, __pyx_n_s__coords, ((PyObject *)__pyx_v_x)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  if (PyObject_SetAttr(__pyx_v_res, __pyx_n_s__grad, ((PyObject *)__pyx_v_g)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_2 = PyFloat_FromDouble(((struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *)__pyx_v_self)->thisptr->get_rms()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyObject_SetAttr(__pyx_v_res, __pyx_n_s__rms, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "playground/native_code/_lbfgs.pyx":92
 * 
 *         res.rms = self.thisptr.get_rms()
 *         res.nsteps = self.thisptr.get_niter()             # <<<<<<<<<<<<<<
 *         res.nfev = self.thisptr.get_nfev()
 ...
 */
  __pyx_t_2 = PyInt_FromLong(((struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *)__pyx_v_self)->thisptr->get_niter()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyObject_SetAttr(__pyx_v_res, __pyx_n_s__nsteps, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  __pyx_t_2 = PyInt_FromLong(((struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *)__pyx_v_self)->thisptr->get_nfev()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyObject_SetAttr(__pyx_v_res, __pyx_n_s__nfev, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *         return res
 */
  __pyx_t_2 = PyFloat_FromDouble(((struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *)__pyx_v_self)->thisptr->get_H0()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyObject_SetAttr(__pyx_v_res, __pyx_n_s__H0, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * 
 */
  __pyx_t_2 = PyInt_FromLong(((struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *)__pyx_v_self)->thisptr->success()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyObject_SetAttr(__pyx_v_res, __pyx_n_s__success, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *                   int nsteps=10000, int verbosity=0):
 */
  __pyx_t_1 = PyFloat_FromDouble(1e-4); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 38; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_k_1 = __pyx_t_1;
