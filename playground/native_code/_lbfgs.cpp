/* Generated by Cython 0.19.2 on Mon Oct 21 17:51:31 2013 */
...
/* "playground/native_code/_lbfgs.pyx":33
 * 
 * 
...
static int __pyx_pf_10playground_11native_code_6_lbfgs_9LBFGS_CPP___cinit__(struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *__pyx_v_self, struct __pyx_obj_10playground_11native_code_5_pele_Potential *__pyx_v_pot, PyArrayObject *__pyx_v_x0, double __pyx_v_tol, int __pyx_v_M, double __pyx_v_maxstep, double __pyx_v_maxErise, double __pyx_v_H0, int __pyx_v_iprint, int __pyx_v_nsteps, int __pyx_v_verbosity); /* proto */
static void __pyx_pf_10playground_11native_code_6_lbfgs_9LBFGS_CPP_2__dealloc__(CYTHON_UNUSED struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_10playground_11native_code_6_lbfgs_9LBFGS_CPP_4run(struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_10playground_11native_code_6_lbfgs_9LBFGS_CPP_6get_result(struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *__pyx_v_self); /* proto */
static int __pyx_pf_5numpy_7ndarray___getbuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info, int __pyx_v_flags); /* proto */
static void __pyx_pf_5numpy_7ndarray_2__releasebuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info); /* proto */
static PyObject *__pyx_tp_new_10playground_11native_code_6_lbfgs_LBFGS_CPP(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
static char __pyx_k_13[] = "playground.native_code";
...
/* Python wrapper */
static int __pyx_pw_10playground_11native_code_6_lbfgs_9LBFGS_CPP_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_10playground_11native_code_6_lbfgs_9LBFGS_CPP_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__pot,&__pyx_n_s__x0,&__pyx_n_s__tol,&__pyx_n_s__M,&__pyx_n_s__maxstep,&__pyx_n_s__maxErise,&__pyx_n_s__H0,&__pyx_n_s__iprint,&__pyx_n_s__nsteps,&__pyx_n_s__verbosity,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__pot)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__x0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__cinit__", 0, 2, 10, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (kw_args > 0) {
    ...
    __pyx_v_pot = ((struct __pyx_obj_10playground_11native_code_5_pele_Potential *)values[0]);
    __pyx_v_x0 = ((PyArrayObject *)values[1]);
    if (values[2]) {
      __pyx_v_tol = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_tol == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
 ...
 */
    ...
    if (values[3]) {
      __pyx_v_M = __Pyx_PyInt_AsInt(values[3]); if (unlikely((__pyx_v_M == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_M = ((int)4);
    }
    if (values[4]) {
      __pyx_v_maxstep = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_maxstep == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_maxstep = ((double)0.1);
    }
    if (values[5]) {
      __pyx_v_maxErise = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_maxErise == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {

      /* "playground/native_code/_lbfgs.pyx":41
 *     def __cinit__(self, _pele.Potential pot, np.ndarray[double, ndim=1,
 *                   mode="c"] x0, double tol=1e-4, int M=4, double maxstep=0.1,
 *                   double maxErise=1e-4, double H0=0.1, int iprint=-1,             # <<<<<<<<<<<<<<
 *                   int nsteps=10000, int verbosity=0):
 ...
 */
    ...
    if (values[6]) {
      __pyx_v_H0 = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_H0 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_H0 = ((double)0.1);
    }
    if (values[7]) {
      __pyx_v_iprint = __Pyx_PyInt_AsInt(values[7]); if (unlikely((__pyx_v_iprint == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_iprint = ((int)-1);
    }
    if (values[8]) {
      __pyx_v_nsteps = __Pyx_PyInt_AsInt(values[8]); if (unlikely((__pyx_v_nsteps == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_nsteps = ((int)10000);
    }
    if (values[9]) {
      __pyx_v_verbosity = __Pyx_PyInt_AsInt(values[9]); if (unlikely((__pyx_v_verbosity == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("__cinit__", 0, 2, 10, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_pot), __pyx_ptype_10playground_11native_code_5_pele_Potential, 1, "pot", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_x0), __pyx_ptype_5numpy_ndarray, 1, "x0", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_10playground_11native_code_6_lbfgs_9LBFGS_CPP___cinit__(((struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *)__pyx_v_self), __pyx_v_pot, __pyx_v_x0, __pyx_v_tol, __pyx_v_M, __pyx_v_maxstep, __pyx_v_maxErise, __pyx_v_H0, __pyx_v_iprint, __pyx_v_nsteps, __pyx_v_verbosity);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = -1;
  __pyx_L0:;
...
/* "playground/native_code/_lbfgs.pyx":39
...
static int __pyx_pf_10playground_11native_code_6_lbfgs_9LBFGS_CPP___cinit__(struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *__pyx_v_self, struct __pyx_obj_10playground_11native_code_5_pele_Potential *__pyx_v_pot, PyArrayObject *__pyx_v_x0, double __pyx_v_tol, int __pyx_v_M, double __pyx_v_maxstep, double __pyx_v_maxErise, double __pyx_v_H0, int __pyx_v_iprint, int __pyx_v_nsteps, int __pyx_v_verbosity) {
  ...
  __pyx_pybuffernd_x0.rcbuffer = &__pyx_pybuffer_x0;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_x0.rcbuffer->pybuffer, (PyObject*)__pyx_v_x0, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "playground/native_code/_lbfgs.pyx":44
 *                   int nsteps=10000, int verbosity=0):
 *         self.thisptr = <cppLBFGS*>new cppLBFGS(pot.thisptr,
 ...
 *         opt = self.thisptr
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_x0), __pyx_n_s__size); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  try {
    __pyx_t_3 = pele::Array(((double *)__pyx_v_x0->data), __pyx_t_2);
  } catch(...) {
    __Pyx_CppExn2PyErr();
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }

  /* "playground/native_code/_lbfgs.pyx":45
 *         self.thisptr = <cppLBFGS*>new cppLBFGS(pot.thisptr,
 *                                                _pele.Array(<double*> x0.data, x0.size),
 *                                                tol, M)             # <<<<<<<<<<<<<<
 *         opt = self.thisptr
 ...
 */
  try {
    __pyx_t_4 = new LBFGS_ns::LBFGS(__pyx_v_pot->thisptr, __pyx_t_3, __pyx_v_tol, __pyx_v_M);
  } catch(...) {
    __Pyx_CppExn2PyErr();
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }

  /* "playground/native_code/_lbfgs.pyx":43
 *                   double maxErise=1e-4, double H0=0.1, int iprint=-1,
 *                   int nsteps=10000, int verbosity=0):
 *         self.thisptr = <cppLBFGS*>new cppLBFGS(pot.thisptr,             # <<<<<<<<<<<<<<
 *                                                _pele.Array(<double*> x0.data, x0.size),
 *                                                tol, M)
 */
  __pyx_v_self->thisptr = ((LBFGS_ns::LBFGS *)__pyx_t_4);
 ...
 */
  ...
  /* "playground/native_code/_lbfgs.pyx":49
 *         opt.set_H0(H0)
 *         opt.set_maxstep(maxstep)
 *         opt.set_max_f_rise(maxErise)             # <<<<<<<<<<<<<<
 *         opt.set_max_iter(nsteps)
...
/* Python wrapper */
static void __pyx_pw_10playground_11native_code_6_lbfgs_9LBFGS_CPP_3__dealloc__(PyObject *__pyx_v_self); /*proto*/
static void __pyx_pw_10playground_11native_code_6_lbfgs_9LBFGS_CPP_3__dealloc__(PyObject *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__ (wrapper)", 0);
  __pyx_pf_10playground_11native_code_6_lbfgs_9LBFGS_CPP_2__dealloc__(((struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *)__pyx_v_self));
  __Pyx_RefNannyFinishContext();
}
...
static void __pyx_pf_10playground_11native_code_6_lbfgs_9LBFGS_CPP_2__dealloc__(CYTHON_UNUSED struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
...
/* Python wrapper */
static PyObject *__pyx_pw_10playground_11native_code_6_lbfgs_9LBFGS_CPP_5run(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_10playground_11native_code_6_lbfgs_9LBFGS_CPP_5run(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("run (wrapper)", 0);
  __pyx_r = __pyx_pf_10playground_11native_code_6_lbfgs_9LBFGS_CPP_4run(((struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *)__pyx_v_self));
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyObject *__pyx_pf_10playground_11native_code_6_lbfgs_9LBFGS_CPP_4run(struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *__pyx_v_self) {
 ...
 */
  __pyx_v_self->thisptr->run(); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s__get_result); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
...
/* Python wrapper */
static PyObject *__pyx_pw_10playground_11native_code_6_lbfgs_9LBFGS_CPP_7get_result(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_10playground_11native_code_6_lbfgs_9LBFGS_CPP_6get_result[] = "return a results object";
static PyObject *__pyx_pw_10playground_11native_code_6_lbfgs_9LBFGS_CPP_7get_result(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_result (wrapper)", 0);
  __pyx_r = __pyx_pf_10playground_11native_code_6_lbfgs_9LBFGS_CPP_6get_result(((struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *)__pyx_v_self));
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyObject *__pyx_pf_10playground_11native_code_6_lbfgs_9LBFGS_CPP_6get_result(struct __pyx_obj_10playground_11native_code_6_lbfgs_LBFGS_CPP *__pyx_v_self) {
 ...
 */
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s__Result); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "playground/native_code/_lbfgs.pyx":71
 *         res = Result()
 * 
 *         cdef _pele.Array xi = self.thisptr.get_x()             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_xi = __pyx_v_self->thisptr->get_x();

  /* "playground/native_code/_lbfgs.pyx":72
 * 
 *         cdef _pele.Array xi = self.thisptr.get_x()
 *         cdef _pele.Array gi = self.thisptr.get_g()             # <<<<<<<<<<<<<<
 *         cdef double *xdata = xi.data()
 ...
 */
  __pyx_v_gi = __pyx_v_self->thisptr->get_g();

  /* "playground/native_code/_lbfgs.pyx":73
 *         cdef _pele.Array xi = self.thisptr.get_x()
 *         cdef _pele.Array gi = self.thisptr.get_g()
 *         cdef double *xdata = xi.data()             # <<<<<<<<<<<<<<
 *         cdef double *gdata = gi.data()
 ...
 */
  ...
  /* "playground/native_code/_lbfgs.pyx":74
 *         cdef _pele.Array gi = self.thisptr.get_g()
 *         cdef double *xdata = xi.data()
 *         cdef double *gdata = gi.data()             # <<<<<<<<<<<<<<
 *         cdef np.ndarray[double, ndim=1, mode="c"] x = np.zeros(xi.size())
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s__zeros); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_FromSize_t(__pyx_v_xi.size()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_x.rcbuffer->pybuffer, (PyObject*)__pyx_t_4, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "playground/native_code/_lbfgs.pyx":76
 *         cdef double *gdata = gi.data()
 *         cdef np.ndarray[double, ndim=1, mode="c"] x = np.zeros(xi.size())
 *         cdef np.ndarray[double, ndim=1, mode="c"] g = np.zeros(xi.size())             # <<<<<<<<<<<<<<
 *         cdef size_t i
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s__zeros); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_FromSize_t(__pyx_v_xi.size()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_g.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    ...
    /* "playground/native_code/_lbfgs.pyx":79
 *         cdef size_t i
 *         for i in xrange(xi.size()):
 *             x[i] = xdata[i]             # <<<<<<<<<<<<<<
 *             g[i] = gdata[i]
 ...
 */
    __pyx_t_8 = __pyx_v_i;
    *__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_x.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_x.diminfo[0].strides) = (__pyx_v_xdata[__pyx_v_i]);
 ...
 */
    __pyx_t_9 = __pyx_v_i;
    *__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_g.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_g.diminfo[0].strides) = (__pyx_v_gdata[__pyx_v_i]);
  }
 ...
 *         res.grad = g
 */
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_self->thisptr->get_f()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (__Pyx_PyObject_SetAttrStr(__pyx_v_res, __pyx_n_s__energy, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * 
 */
  if (__Pyx_PyObject_SetAttrStr(__pyx_v_res, __pyx_n_s__coords, ((PyObject *)__pyx_v_x)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  if (__Pyx_PyObject_SetAttrStr(__pyx_v_res, __pyx_n_s__grad, ((PyObject *)__pyx_v_g)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "playground/native_code/_lbfgs.pyx":93
 *         res.grad = g
 * 
 *         res.rms = self.thisptr.get_rms()             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_self->thisptr->get_rms()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (__Pyx_PyObject_SetAttrStr(__pyx_v_res, __pyx_n_s__rms, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "playground/native_code/_lbfgs.pyx":94
 * 
 *         res.rms = self.thisptr.get_rms()
 *         res.nsteps = self.thisptr.get_niter()             # <<<<<<<<<<<<<<
 *         res.nfev = self.thisptr.get_nfev()
 ...
 */
  __pyx_t_2 = PyInt_FromLong(__pyx_v_self->thisptr->get_niter()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (__Pyx_PyObject_SetAttrStr(__pyx_v_res, __pyx_n_s__nsteps, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "playground/native_code/_lbfgs.pyx":95
 *         res.rms = self.thisptr.get_rms()
 *         res.nsteps = self.thisptr.get_niter()
 *         res.nfev = self.thisptr.get_nfev()             # <<<<<<<<<<<<<<
 *         res.H0 = self.thisptr.get_H0()
 ...
 */
  __pyx_t_2 = PyInt_FromLong(__pyx_v_self->thisptr->get_nfev()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (__Pyx_PyObject_SetAttrStr(__pyx_v_res, __pyx_n_s__nfev, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "playground/native_code/_lbfgs.pyx":96
 *         res.nsteps = self.thisptr.get_niter()
 *         res.nfev = self.thisptr.get_nfev()
 *         res.H0 = self.thisptr.get_H0()             # <<<<<<<<<<<<<<
 *         res.success = self.thisptr.success()
 *         return res
 */
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_self->thisptr->get_H0()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (__Pyx_PyObject_SetAttrStr(__pyx_v_res, __pyx_n_s__H0, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "playground/native_code/_lbfgs.pyx":97
 *         res.nfev = self.thisptr.get_nfev()
 *         res.H0 = self.thisptr.get_H0()
 *         res.success = self.thisptr.success()             # <<<<<<<<<<<<<<
 *         return res
 * 
 */
  __pyx_t_2 = PyInt_FromLong(__pyx_v_self->thisptr->success()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (__Pyx_PyObject_SetAttrStr(__pyx_v_res, __pyx_n_s__success, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "playground/native_code/_lbfgs.pyx":98
 *         res.H0 = self.thisptr.get_H0()
 *         res.success = self.thisptr.success()
 *         return res             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_tp_new_10playground_11native_code_6_lbfgs_LBFGS_CPP(PyTypeObject *t, PyObject *a, PyObject *k) {
  ...
  if (unlikely(__pyx_pw_10playground_11native_code_6_lbfgs_9LBFGS_CPP_1__cinit__(o, a, k) < 0)) {
    Py_DECREF(o); o = 0;
  }
  return o;
}
...
static void __pyx_tp_dealloc_10playground_11native_code_6_lbfgs_LBFGS_CPP(PyObject *o) {
  ...
  PyObject_GC_UnTrack(o);
  {
    ...
    ++Py_REFCNT(o);
    __pyx_pw_10playground_11native_code_6_lbfgs_9LBFGS_CPP_3__dealloc__(o);
...
static PyMethodDef __pyx_methods_10playground_11native_code_6_lbfgs_LBFGS_CPP[] = {
  {__Pyx_NAMESTR("run"), (PyCFunction)__pyx_pw_10playground_11native_code_6_lbfgs_9LBFGS_CPP_5run, METH_NOARGS, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("get_result"), (PyCFunction)__pyx_pw_10playground_11native_code_6_lbfgs_9LBFGS_CPP_7get_result, METH_NOARGS, __Pyx_DOCSTR(__pyx_doc_10playground_11native_code_6_lbfgs_9LBFGS_CPP_6get_result)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__lbfgs(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_lbfgs"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "playground.native_code._lbfgs")) {
      if (unlikely(PyDict_SetItemString(modules, "playground.native_code._lbfgs", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_10playground_11native_code_6_lbfgs_LBFGS_CPP) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "LBFGS_CPP", (PyObject *)&__pyx_type_10playground_11native_code_6_lbfgs_LBFGS_CPP) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
