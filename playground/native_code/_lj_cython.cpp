...
__PYX_EXTERN_C DL_IMPORT(void) ljenergy_(double *, int *, double *, double *, double *, int *, double *); /*proto*/
static double __pyx_f_10playground_11native_code_10_lj_cython__lj_energy_grad(pele::Array<double>, pele::Array<double>, void *); /*proto*/
static double __pyx_f_10playground_11native_code_10_lj_cython__lj_energy(pele::Array<double>, void *); /*proto*/
...
static double __pyx_f_10playground_11native_code_10_lj_cython__lj_energy_grad(pele::Array<double> __pyx_v_x, pele::Array<double> __pyx_v_grad, void *__pyx_v_userdata) {
  double *__pyx_v_data;
  ...
  __Pyx_RefNannySetupContext("_lj_energy_grad");
 ...
 */
  ...
  /* "playground/native_code/_lj_cython.pyx":27
 *     cdef double sigma=data[0]
 *     cdef double eps=data[1]
 *     cdef double boxl=-1.0             # <<<<<<<<<<<<<<
 *     cdef int natoms = x.size() / 3
 ...
 *     cdef int periodic = 0
 */
  __pyx_v_natoms = (__pyx_v_x.size() / 3);
 ...
 */
  ...
  /* "playground/native_code/_lj_cython.pyx":32
 *     cdef int periodic = 0
 *     ljenergy_gradient_(x.data(), &natoms, &e, grad.data(),
 *                        &eps, &sigma, &periodic, &boxl)             # <<<<<<<<<<<<<<
 *     return e
 * 
 */
  ljenergy_gradient_(__pyx_v_x.data(), (&__pyx_v_natoms), (&__pyx_v_e), __pyx_v_grad.data(), (&__pyx_v_eps), (&__pyx_v_sigma), (&__pyx_v_periodic), (&__pyx_v_boxl));

  /* "playground/native_code/_lj_cython.pyx":33
 *     ljenergy_gradient_(x.data(), &natoms, &e, grad.data(),
 *                        &eps, &sigma, &periodic, &boxl)
 *     return e             # <<<<<<<<<<<<<<
 * 
...
/* "playground/native_code/_lj_cython.pyx":35
 *     return e
 * 
 * cdef double _lj_energy(_pele.Array[double] x, void *userdata) except *:             # <<<<<<<<<<<<<<
 *     cdef double *data = <double*>userdata
...
static double __pyx_f_10playground_11native_code_10_lj_cython__lj_energy(pele::Array<double> __pyx_v_x, void *__pyx_v_userdata) {
  double *__pyx_v_data;
  double __pyx_v_sigma;
  double __pyx_v_eps;
  double __pyx_v_boxl;
  ...
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_lj_energy");

  /* "playground/native_code/_lj_cython.pyx":36
 * 
 * cdef double _lj_energy(_pele.Array[double] x, void *userdata) except *:
 *     cdef double *data = <double*>userdata             # <<<<<<<<<<<<<<
 *     cdef double sigma=data[0]
 ...
 */
  ...
  /* "playground/native_code/_lj_cython.pyx":37
 * cdef double _lj_energy(_pele.Array[double] x, void *userdata) except *:
 *     cdef double *data = <double*>userdata
 *     cdef double sigma=data[0]             # <<<<<<<<<<<<<<
 *     cdef double eps=data[1]
 ...
 */
  ...
  /* "playground/native_code/_lj_cython.pyx":39
 *     cdef double sigma=data[0]
 *     cdef double eps=data[1]
 *     cdef double boxl=-1.0             # <<<<<<<<<<<<<<
 *     cdef int natoms = x.size() / 3
 ...
 */
  ...
  /* "playground/native_code/_lj_cython.pyx":40
 *     cdef double eps=data[1]
 *     cdef double boxl=-1.0
 *     cdef int natoms = x.size() / 3             # <<<<<<<<<<<<<<
 *     cdef double e
 ...
 */
  ...
  /* "playground/native_code/_lj_cython.pyx":44
 *     cdef int periodic = 0
 *     ljenergy_(x.data(), &natoms, &e,
 *                        &eps, &sigma, &periodic, &boxl)             # <<<<<<<<<<<<<<
 *     return e
 * 
 */
  ljenergy_(__pyx_v_x.data(), (&__pyx_v_natoms), (&__pyx_v_e), (&__pyx_v_eps), (&__pyx_v_sigma), (&__pyx_v_periodic), (&__pyx_v_boxl));

  /* "playground/native_code/_lj_cython.pyx":45
 *     ljenergy_(x.data(), &natoms, &e,
 *                        &eps, &sigma, &periodic, &boxl)
 *     return e             # <<<<<<<<<<<<<<
 * 
...
/* "playground/native_code/_lj_cython.pyx":52
 *     cdef double _data[2]
 * 
...
static int __pyx_pf_10playground_11native_code_10_lj_cython_9LJ_cython___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "playground/native_code/_lj_cython.pyx":53
 * 
 *     def __cinit__(self, sigma=1.0, epsilon=1.0):
 *         self._data[0] = sigma             # <<<<<<<<<<<<<<
 *         self._data[1] = epsilon
 ...
 */
  __pyx_t_1 = __pyx_PyFloat_AsDouble(__pyx_v_sigma); if (unlikely((__pyx_t_1 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  (((struct __pyx_obj_10playground_11native_code_10_lj_cython_LJ_cython *)__pyx_v_self)->_data[0]) = __pyx_t_1;

  /* "playground/native_code/_lj_cython.pyx":54
 *     def __cinit__(self, sigma=1.0, epsilon=1.0):
 *         self._data[0] = sigma
 *         self._data[1] = epsilon             # <<<<<<<<<<<<<<
 *         # PotentialFunction uses lj_energy and lj_grad as callback
 ...
 */
  __pyx_t_1 = __pyx_PyFloat_AsDouble(__pyx_v_epsilon); if (unlikely((__pyx_t_1 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  (((struct __pyx_obj_10playground_11native_code_10_lj_cython_LJ_cython *)__pyx_v_self)->_data[1]) = __pyx_t_1;

  /* "playground/native_code/_lj_cython.pyx":60
 *                                            &_lj_energy,
 *                                            &_lj_energy_grad,
 *                                            <void*>self._data)             # <<<<<<<<<<<<<<
 */
  try {__pyx_t_2 = new pele::PotentialFunction((&__pyx_f_10playground_11native_code_10_lj_cython__lj_energy), (&__pyx_f_10playground_11native_code_10_lj_cython__lj_energy_grad), ((void *)((struct __pyx_obj_10playground_11native_code_10_lj_cython_LJ_cython *)__pyx_v_self)->_data));} catch(...) {__Pyx_CppExn2PyErr(); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}

  /* "playground/native_code/_lj_cython.pyx":57
 *         # PotentialFunction uses lj_energy and lj_grad as callback
 *         # and self._data is passed to each function call
 ...
 *                                            &_lj_energy_grad,
 */
  ((struct __pyx_obj_10playground_11native_code_10_lj_cython_LJ_cython *)__pyx_v_self)->__pyx_base.thisptr = ((pele::BasePotential *)__pyx_t_2);
...
#endif
{
  ...
  __pyx_type_10playground_11native_code_10_lj_cython_LJ_cython.tp_base = __pyx_ptype_10playground_11native_code_5_pele_BasePotential;
  if (PyType_Ready(&__pyx_type_10playground_11native_code_10_lj_cython_LJ_cython) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "LJ_cython", (PyObject *)&__pyx_type_10playground_11native_code_10_lj_cython_LJ_cython) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
