...
if __name__ == "__main__":
    ...
    #Parallel Tempering
    mcrunner = Metropolis_MCrunner(potential, start_coords, niter=1e5, stepsize=1, hEmax = 1000, adjustf = 0.9, adjustf_niter = 1e5, radius=1000000)
    ptrunner = MPI_PT_RLhandshake(mcrunner, 0.2,1.6, max_ptiter=1000, pfreq=100, verbose=False)
    ptrunner.run()
