/* Generated by Cython 0.15.1 on Fri Mar 28 15:31:54 2014 */
 ...
 * 
 */
  __pyx_t_3 = PyObject_GetAttr(__pyx_v_self, __pyx_n_s__NumericalHessian); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
...
static PyObject *__pyx_pf_4pele_10potentials_5_pele_13BasePotential_8NumericalHessian(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_4pele_10potentials_5_pele_13BasePotential_8NumericalHessian(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_x = 0;
  double __pyx_v_eps;
  ...
  __Pyx_RefNannySetupContext("NumericalHessian");
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "NumericalHessian") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  2: values[1] = PyTuple_GET_ITEM(__pyx_args, 1);
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  try {__pyx_t_6 = pele::Array<double>(((double *)__pyx_v_x->data), __pyx_t_5);} catch(...) {__Pyx_CppExn2PyErr(); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
 ...
 */
  try {((struct __pyx_obj_4pele_10potentials_5_pele_BasePotential *)__pyx_v_self)->thisptr->numerical_hessian(__pyx_t_6, __pyx_t_7, __pyx_v_eps);} catch(...) {__Pyx_CppExn2PyErr(); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
...
static PyMethodDef __pyx_methods_4pele_10potentials_5_pele_BasePotential[] = {
  ...
  {__Pyx_NAMESTR("NumericalHessian"), (PyCFunction)__pyx_pf_4pele_10potentials_5_pele_13BasePotential_8NumericalHessian, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
