...
static int __pyx_pf_4pele_10potentials_10_morse_cpp_5Morse___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pf_4pele_10potentials_10_morse_cpp_5Morse___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
 ...
 */
  ...
  try {__pyx_t_4 = new pele::Morse(__pyx_t_1, __pyx_t_2, __pyx_t_3);} catch(...) {__Pyx_CppExn2PyErr(); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
  ((struct __pyx_obj_4pele_10potentials_10_morse_cpp_Morse *)__pyx_v_self)->__pyx_base.thisptr = ((pele::BasePotential *)__pyx_t_4);
...
static PyObject *__pyx_tp_new_4pele_10potentials_10_morse_cpp_Morse(PyTypeObject *t, PyObject *a, PyObject *k) {
  ...
  if (!o) return 0;
  if (__pyx_pf_4pele_10potentials_10_morse_cpp_5Morse___cinit__(o, a, k) < 0) {
    Py_DECREF(o); o = 0;
  }
  return o;
}
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__morse_cpp(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_morse_cpp"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
