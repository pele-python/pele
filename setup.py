...
cxx_modules = [
    ...
    Extension("pele.potentials._inversepower_stillinger_cut_cpp",
              ["pele/potentials/_inversepower_stillinger_cut_cpp.cxx"] + include_sources,
              include_dirs=include_dirs,
              extra_compile_args=extra_compile_args,
              language="c++", depends=depends,
             ),
    Extension("pele.potentials._xy_model_online_cpp",
              ["pele/potentials/_xy_model_online_cpp.cxx"] + include_sources,
              include_dirs=include_dirs,
              extra_compile_args=extra_compile_args,
              language="c++", depends=depends,
             ),
    Extension("pele.potentials._ml_cost_online_cpp",
              ["pele/potentials/_ml_cost_online_cpp.cxx"] + include_sources,
              include_dirs=include_dirs,
              extra_compile_args=extra_compile_args,
              language="c++", depends=depends,
             ),
    ...
    Extension("pele.optimize._steepest_descent_cpp", 
              ["pele/optimize/_steepest_descent_cpp.cxx"] + include_sources,
              include_dirs=include_dirs,
              extra_compile_args=extra_compile_args,
              language="c++", depends=depends,
              ),
    Extension("pele.optimize._stochastic_gradient_descent_cpp", 
              ["pele/optimize/_stochastic_gradient_descent_cpp.cxx"] + include_sources,
              include_dirs=include_dirs,
              extra_compile_args=extra_compile_args,
              language="c++", depends=depends,
              ),
    Extension("pele.optimize._stochastic_diagonal_levenberg_marquardt_cpp", 
              ["pele/optimize/_stochastic_diagonal_levenberg_marquardt_cpp.cxx"] + include_sources,
              include_dirs=include_dirs,
              extra_compile_args=extra_compile_args,
              language="c++", depends=depends,
              ),
