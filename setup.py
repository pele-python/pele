...
cxx_modules = [
    ...
    Extension("pele.monte_carlo._pele_mc", 
              ["pele/monte_carlo/_pele_mc.cpp"] + include_sources,
              include_dirs=include_dirs,
              extra_compile_args=extra_compile_args,
              language="c++", depends=depends,
              ),
    Extension("pele.monte_carlo._monte_carlo_cpp", 
              ["pele/monte_carlo/_monte_carlo_cpp.cpp"] + include_sources,
              include_dirs=include_dirs,
              extra_compile_args=extra_compile_args,
              language="c++", depends=depends,
              ),
    Extension("pele.monte_carlo._takestep_cpp", 
              ["pele/monte_carlo/_takestep_cpp.cpp"] + include_sources,
              include_dirs=include_dirs,
              extra_compile_args=extra_compile_args,
              language="c++", depends=depends,
              ),
    Extension("pele.monte_carlo._accept_test_cpp", 
              ["pele/monte_carlo/_accept_test_cpp.cpp"] + include_sources,
              include_dirs=include_dirs,
              extra_compile_args=extra_compile_args,
              language="c++", depends=depends,
              ),
    Extension("pele.monte_carlo._conf_test_cpp", 
              ["pele/monte_carlo/_conf_test_cpp.cpp"] + include_sources,
              include_dirs=include_dirs,
              extra_compile_args=extra_compile_args,
              language="c++", depends=depends,
              ),
    Extension("pele.monte_carlo._action_cpp", 
              ["pele/monte_carlo/_action_cpp.cpp"] + include_sources,
              include_dirs=include_dirs,
              extra_compile_args=extra_compile_args,
              language="c++", depends=depends,
              ),
