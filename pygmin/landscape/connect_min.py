...
#    def _mergeMinimaGdist(self, min1, min2):
#        if True:
...
#        else:
#            #this doesn't work
#            print "Gdist nnodes before", self.Gdist.number_of_nodes()
#            nx.relabel_nodes(self.Gdist, {min2:min1})
#            print "Gdist nnodes after ", self.Gdist.number_of_nodes()
